...
<div class="alert alert-info">Ingresos: $<?php echo number_format($totales['ingresos'],0,',','.'); ?> | Egresos: $<?php echo number_format($totales['egresos'],0,',','.'); ?> | Saldo neto: $<?php echo number_format($totales['ingresos']+$totales['egresos'],0,',','.'); ?></div>
