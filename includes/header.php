...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        ...
        <nav>
            ...
            <a class="nav-link-sidebar<?php echo in_array($currentPage, ['movimientos_socio.php', 'libro_diario.php'], true) ? ' active' : ''; ?>" href="movimientos_socio.php"><i class="bi bi-person-lines-fill"></i><span>Movimientos por socio</span></a>
            <?php if ($isAdmin): ?>
                <a class="nav-link-sidebar<?php echo $currentPage === 'libro_diario.php' ? ' active' : ''; ?>" href="libro_diario.php"><i class="bi bi-journal-spreadsheet"></i><span>Libro diario</span></a>
            <?php endif; ?>
